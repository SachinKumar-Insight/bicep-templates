...
var adlsStorageAccountPrivateEndpointId = adlsStorageAccountPrivateEndpoint.id
...
var adlsPrivateDnsZoneGroup_var = '${adlsStorageAccountPrivateEndpointName}/${adlsStorageAccountPrivateEndpointGroupName}PrivateDnsZoneGroup'
...
resource vm 'Microsoft.Compute/virtualMachines@2019-12-01' = {
  ...
  dependsOn: [
    adlsStorageAccountPrivateEndpointId
...
resource adlsStorageAccountPrivateEndpoint 'Microsoft.Network/privateEndpoints@2020-04-01' = {
  ...
  properties: {
    ...
    customDnsConfigs: [
      {
        fqdn: concat(adlsStorageAccountName, adlsPublicDNSZoneForwarder)
      }
    ]
  }
  dependsOn: [
...
resource adlsPrivateDnsZoneGroup 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2020-03-01' = {
  name: adlsPrivateDnsZoneGroup_var
  location: location
  properties: {
...
output adlsStorageAccountPrivateEndpoint object = reference(adlsStorageAccountPrivateEndpoint.id, '2020-04-01', 'Full')
output blobStorageAccountPrivateEndpoint object = reference(blobStorageAccountPrivateEndpoint.id, '2020-04-01', 'Full')
output adlsStorageAccount object = reference(adlsStorageAccount.id, '2019-06-01', 'Full')
